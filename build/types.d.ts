...
export interface SpecificOptions<Opts extends Partial<ArgOptions>> {
    ...
    namedArgs: ArgOptions extends Opts ? Record<string, string | boolean | undefined | null> : Opts["namedArgs"] extends {} ? NamedArgs<Opts["namedArgs"]> : {};
...
type NamedArgFrom<O extends NamedArgOptions> = O["valueless"] extends true ? O["optional"] extends false ? true : (false | true) : O["optional"] extends true ? (string | undefined | null) : string;
