...
describe("Script", () => {
	it("should run a script without crashing", () => {
		...
		script.run(["node", fakePathToApp], {throwOnError: true});
	...
	it("should accept named arguments", () => {
		...
		spyOn(script.defaultCommand, "handler").and.callThrough();
		script.run(["node", fakePathToApp, `--namedarg1`, `namedvalue1`], {throwOnError: true});
		expect(script.defaultCommand.handler).toHaveBeenCalled();
	});
	...
	it("should accept positional arguments", () => {
		...
		spyOn(script.defaultCommand, "handler").and.callThrough();
		script.run(["node", fakePathToApp, `namedvalue1`], {throwOnError: true});
		expect(script.defaultCommand.handler).toHaveBeenCalled();
	});
	...
	it("should fill in default values for named arguments", () => {
		...
		spyOn(script.defaultCommand, "handler").and.callThrough();
		script.run(["node", fakePathToApp, `--optional2`], {throwOnError: true});
		expect(script.defaultCommand.handler).toHaveBeenCalled();
	});
	...
	it("should fill in default values for positional arguments", () => {
		...
		spyOn(script.defaultCommand, "handler").and.callThrough();
		script.run(["node", fakePathToApp, `value1`], {throwOnError: true});
		expect(script.defaultCommand.handler).toHaveBeenCalled();
	});
	...
	it("should accept aliases for named arguments", () => {
		...
		spyOn(script.defaultCommand, "handler").and.callThrough();
		script.run(["node", fakePathToApp, `--alias1`, `namedvalue1`, `--alias2`, `namedvalue2`], {throwOnError: true});
		expect(script.defaultCommand.handler).toHaveBeenCalled();
	});
	...
	it("should correctly handle parsing positional args following valueless named args", () => {
		...
		spyOn(script.defaultCommand, "handler").and.callThrough();
		script.run(["node", fakePathToApp, `--alias1`, `posarg1`, `--namedarg2`, `namedvalue2`], {throwOnError: true});
		expect(script.defaultCommand.handler).toHaveBeenCalled();
	});
