...
describe("Application", () => {
	...
	it("should run an application without crashing", () => {
		...
		app.run(["node", fakePathToApp, `cmd1`], {throwOnError: true});
	...
	it("should accept named arguments", () => {
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		app.run(["node", fakePathToApp, `cmd1`, `--namedarg1`, `namedvalue1`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});

	it("should accept valueless named arguments", () => {
		const app = new Application("test-app", "Autogenerated test app");
		app.command("cmd1", "test command", (opts, app) => {
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		app.run(["node", fakePathToApp, `cmd1`, `--namedarg1`, `notnamedvalue1`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});
	...
	it("should accept positional arguments", () => {
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		app.run(["node", fakePathToApp, `cmd1`, `namedvalue1`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});
	...
	it("should fill in default values for named arguments", () => {
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		app.run(["node", fakePathToApp, `cmd1`, `--optional2`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});
	...
	it("should fill in default values for positional arguments", () => {
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		app.run(["node", fakePathToApp, `cmd1`, `value1`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});
	...
	it("should run a command through aliases", () => {
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		app.run(["node", fakePathToApp, `alias1`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});
	...
	it("should accept aliases for named arguments", () => {
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		app.run(["node", fakePathToApp, `cmd1`, `--alias1`, `namedvalue1`, `--alias2`, `namedvalue2`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});

	it("should correctly obtain sourceDirectory", () => {
		const app = new Application("test-app", "Autogenerated test app");
		app.command("cmd1", "test command", (opts, app) => {
			//do nothing
		});
		...
		app.run(["node", `F:\\index.js`, `cmd1`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalledWith(jasmine.anything(), jasmine.objectContaining({
			sourceDirectory: jasmine.stringMatching(/F:[/\\]?/)
		}));
		app.run(["node", `/home/username/Documents/coding/js/sussy/sus.js`, `cmd1`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalledWith(jasmine.anything(), jasmine.objectContaining({
