...
function typesEqual<A, B>():[A] extends [B] ? [B] extends [A] ? true : false : false {
	return null!;
}
...
describe("Application", () => {
	...
	it("should accept named arguments", async () => {
		...
		app.command("cmd1", "test command", (opts, app) => {
			typesEqual<string, typeof opts.namedArgs["namedarg1"]>() satisfies true;
	...
	it("should handle named arguments being optional", async () => {
		const app = new Application("test-app", "Autogenerated test app");
		app.command("cmd1", "test command", (opts, app) => {
			typesEqual<typeof opts.namedArgs["passed_without_value"], string | null | undefined>() satisfies true;
			typesEqual<typeof opts.namedArgs["not_passed"], string | null | undefined>() satisfies true;
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		await app.run(["node", fakePathToApp, `cmd1`, `--passed_without_value`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});
	...
	it("should accept valueless named arguments", async () => {
		const app = new Application("test-app", "Autogenerated test app");
		app.command("cmd1", "test command", (opts, app) => {
			typesEqual<typeof opts.namedArgs.namedarg1, boolean>() satisfies true;
			typesEqual<typeof opts.namedArgs.namedarg2, boolean>() satisfies true;
	...
	it("should accept required valueless named arguments", async () => {
		const app = new Application("test-app", "Autogenerated test app");
		app.command("cmd1", "test command", (opts, app) => {
			typesEqual<typeof opts.namedArgs.namedarg1, true>() satisfies true;
			expect(opts.namedArgs.namedarg1).toEqual(true);
		}, false, {
			namedArgs: {
				namedarg1: {
		...
		expectAsync(app.run(["node", fakePathToApp, `cmd1`], {throwOnError: true})).toBeRejectedWith(applicationError("required named arg"));
	});
	...
	it("should fail if a required named argument is not passed", async () => {
		const app = new Application("test-app", "Autogenerated test app");
		app.command("cmd1", "test command", (opts, app) => {
			typesEqual<typeof opts.namedArgs.namedarg1, string>() satisfies true;
	...
	it("should fail if an unexpected named argument is passed", async () => {
		...
		await expectAsync(app.run(["node", fakePathToApp, `-namedarg1`], {throwOnError: true}))
			.toBeRejectedWith(applicationError("required named arg"));
	...
	it("should fill in default values for named arguments", async () => {
		const app = new Application("test-app", "Autogenerated test app");
		app.command("cmd1", "test command", (opts, app) => {
			typesEqual<typeof opts.namedArgs.optional1, string>() satisfies true;
			typesEqual<typeof opts.namedArgs.optional2, string>() satisfies true;
			typesEqual<typeof opts.namedArgs.optional3, string>() satisfies true;
			typesEqual<typeof opts.namedArgs.optional4, string | undefined | null>() satisfies true;
			typesEqual<typeof opts.namedArgs.optional5, string | undefined | null>() satisfies true;
			typesEqual<typeof opts.namedArgs.optional6, string | undefined | null>() satisfies true;
		...
		spyOn(app.commands["cmd1"]!, "handler").and.callThrough();
		await app.run(["node", fakePathToApp, `cmd1`, `--optional2`, `--optional2`, `modified`, `--optional4`, `value4`, `--optional6`], {throwOnError: true});
		expect(app.commands["cmd1"]!.handler).toHaveBeenCalled();
	});
	...
	it("should call process.exit when an exit code is returned", async () => {
		...
		spyOn(process, "exit");
		await app.run(["node", fakePathToApp, "cmd1"]);
	...
	it("should wait for async handlers to return", async () => {
		...
		expect(state).toBe(0);
		const result = app.run(["node", fakePathToApp, "cmd1"]);
		expect(state).toBe(1);
		await result;
		expect(state).toBe(2);
	});
